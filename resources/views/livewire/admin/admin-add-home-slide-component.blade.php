                                ...
                                <form wire:submit.prevent="addSlider">
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" class="form-control" 
                                            placeholder="Ingrese nueva titulo  slider" wire:model="top_title"/>
                                        @error('top_title')
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter slider title" wire:model="sub_title" />
                                        @error('sub_title')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter slider title" wire:model="offer" />
                                        @error('offer')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter slider title" wire:model="link" />
                                        @error('link')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
