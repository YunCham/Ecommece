                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-info">
                                        ...
                                        <div class="short-desc mb-30">
                                            <p>{{$product->shop_description}}</p>   {{--breve descripcion de un producto con  la bd--}}
                                        </div>
                                        ...
                                        <div class="detail-extralink">
                                            ...
                                            <div class="product-extra-link2">
                                                ...
                                                wire:click.prevent="store({{$product->id}},'{{$product->name}}',{{$product->regular_price}})">Añadir a carrito</button>
                            ...
                            <div class="row mt-60">
                                ...
                                <div class="col-12">
                                    <div class="row related-products">
                                        ...
                                        {{-- forcito para mostrar sugerencias de productos similares --}}
