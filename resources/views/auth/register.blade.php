                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post" action="{{route('register')}}">
                                            ...
                                            <div class="form-group">
                                                <input type="text" required="" name="name" placeholder="nombre" :value="odl('name')" required autofocus autocomplete="name">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" required="" name="email" placeholder="Email":value="odl('email')" required>
                                            </div>
                                            <div class="form-group">
                                                <input required="" type="password" name="password" placeholder="contraseña/password" required autocomplete="new-password" >
                                            </div>
                                            <div class="form-group">
